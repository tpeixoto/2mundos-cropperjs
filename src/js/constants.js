...
export const EVENT_POINTER_DOWN = window.orientation < 0 ? 'pointerdown' : 'touchstart mousedown';
export const EVENT_POINTER_MOVE = window.orientation < 0 ? 'pointermove' : 'touchmove mousemove';
export const EVENT_POINTER_UP = window.orientation < 0 ? 'pointerup pointercancel' : 'touchend touchcancel mouseup';
